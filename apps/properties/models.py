...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(default="Default description... update me please....")
    country = CountryField(default="NG", blank_label="(select country)")
    ...
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="LG7 Avenue")
    ...
    plot_area = models.DecimalField(verbose_name = _("Plot Area(m²)"), max_digits=8, decimal_places=2, default=0.0)
