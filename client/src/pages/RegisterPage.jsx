...
const RegisterPage = () => {
  ...
  useEffect(() => {
    ...
    if (isSuccess || user) {
      navigate("/")
      toast.success("An activation email has been sent to your email address. Please check your email");
    }
        ...
        <Row className="mt-3">
            <Col className='justify-content-center'>
                ...
                <Form.Group controlId="re_password">
                    ...
                    <Form.Control type="password" placeholder='Enter Confirm Password' value={re_password} onChange={(e) => setRePassword(e.target.value)} />
                </Form.Group>
